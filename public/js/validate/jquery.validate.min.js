...
! function(a) {
    ...
    a.extend(a.fn, {
        ...
        messages: {
            ...
            maxlength: a.validator.format("Por favor no ingrese mas de {0} caracteres o numeros."),
            minlength: a.validator.format("Por favor ingrese almenos {0} characters."),
            rangelength: a.validator.format("Por favor ingrese una cadena que contencta entre {0} y {1} caracteres."),
            range: a.validator.format("Por favor ingrese un numero entre {0} y {1}."),
