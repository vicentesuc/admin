    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" id="form-event">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="input_event_franchise">
                        Franquicia</label>
                    <div class="col-sm-9">
                        <select class="col-xs-10 col-sm-5" id="input_event_franchise" name="input_event_franchise"
                                required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="col-xs-10 col-sm-5" id="input_event_language" name="input_event_language"
                                required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <img id="prev_image" class="img img-responsive " src="#" alt="your image" width="100"
                             height="75"/>
                    </div>
                </div>
                <hr>
